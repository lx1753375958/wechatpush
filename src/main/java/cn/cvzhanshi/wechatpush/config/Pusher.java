...
public class Pusher {
    ...
    private static String appId = "wxf859c599ac9207ea";
    private static String secret = "f123a6c85db37f3b14dec37d9c07d52c";
    ...
    public static void push(){
        ...
        WxMpTemplateMessage templateMessage = WxMpTemplateMessage.builder()
                .toUser("osvWZ5ssPqp_fjZO3EuRV_N4wTOY")
                .templateId("h_olbQ3aWSyOmxVz0L0EcZngvGhDysoZHcHExQE9Ls4")
                .build();
